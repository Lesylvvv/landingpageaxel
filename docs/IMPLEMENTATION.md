...
Les textes des trois rendez-vous, les situations, les résultats, les arguments de différenciation, la méthode, les statistiques et la FAQ sont centralisés dans `src/data/landing-content.ts`.
...
L’ordre de la page suit : pertinence, connexion vidéo, identification, valeur, différenciation, méthode, preuve, choix du rendez-vous, réassurance puis réservation. La FAQ précède le calendrier et le calendrier termine le parcours principal.
