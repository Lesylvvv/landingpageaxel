...
- Typographie : hero plafonné à environ 62 px, titres de section à environ 43 px, corps de texte entre 16 et 17 px.
- Grille : conteneur principal plafonné à 1 100 px, marges internes de 20 px sur tablette et mobile ; la vidéo conserve sa largeur maximale de 940 px et son comportement responsive dédié.
